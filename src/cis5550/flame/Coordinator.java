...
class Coordinator extends cis5550.generic.Coordinator {
  ...
  static int myPort;
    ...
    post("/rdd", (request, response) -> {
        ...
        url.append("http://").append(request.queryParams("worker")).append("/rdd?oper=").append(request.queryParams("oper")).append("&kvsCoordinator=").append(kvsCoordinator)
        .append("&from=").append(request.queryParams("from")).append("&to=").append(request.queryParams("to")).append("&input=").append(request.queryParams("input"))
    ...
    post("/fromTable", (request, response) -> {
        ...
        url.append("http://").append(request.queryParams("worker")).append("/fromTable?kvsCoordinator=").append(kvsCoordinator)
        .append("&from=").append(request.queryParams("from")).append("&to=").append(request.queryParams("to")).append("&input=").append(request.queryParams("input"))
        .append("&output=").append(request.queryParams("output")).append("&jar=").append(request.queryParams("jar"));
