...
public class Mainpage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // broswer->http server->backend server(search keys in kvs table)->http
        // server->broswer
        get("/search", (req, res) -> {
    ...
    private static String formatSearchResults(List<Map.Entry<String, Double>> sortedEntries,
            Map<String, String[]> pageDetails) {
