...
public class ClientHandler extends Thread {
	...
	public boolean routeMatches(Server.RoutePattern route, String reqPath, String method,
	...
	public RequestImpl generateRequest(StringBuilder sb, ByteArrayOutputStream buffer, InetSocketAddress remoteAddr,
		...
		RequestImpl request = new RequestImpl(reqMethod, reqPath, httpVersion, headers, queryParams, null, remoteAddr,
				bodyAsBytes, server);
		return request;
	}

	public boolean checkError(RequestImpl request, PrintWriter writer) {
		if (request.method == null || request.url == null || request.protocol == null
