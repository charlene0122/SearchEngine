...
public class Coordinator {
    ...
    public static Vector<String> getWorkers() {
        ...
        checkExpired();
        workers.forEach((id, worker) -> results.add(worker.ip() + ":" + worker.port()));
        return results;
    }
    ...
    public static void registerRoutes() {
        ...
        Server.get("/ping", (req, res) -> {
            ...
            // logger.info("ping " +req.ip() + " " + port + "time: " +
        ...
        get("/workers", (req, res) -> {
            ...
            workers.forEach((id, worker) -> builder.append(id).append(",").append(worker.ip()).append(":")
                    .append(worker.port()).append("\n"));
